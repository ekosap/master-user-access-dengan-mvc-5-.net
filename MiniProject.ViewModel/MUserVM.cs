...
namespace MiniProject.ViewModel
{
    public class MUserVM
    {
        ...
        [RegularExpression("^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)[a-zA-Z\\d]{8,}$",ErrorMessage ="Password Minimum 8 Characters, at least one LOWERCASE letter, at least one UPPERCASE letter and one NUMBER")]
