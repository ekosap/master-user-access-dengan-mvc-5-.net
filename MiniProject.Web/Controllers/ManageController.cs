...
namespace MiniProject.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            var linkedAcounts = UserManager.GetLogins((User.Identity.GetUserId<int>()));
            ViewBag.ShowRemoveButton = HasPassword() || linkedAcounts.Count > 1;
            return View(linkedAcounts);
        }
